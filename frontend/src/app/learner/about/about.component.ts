...
@Component({
  ...
  template: `
    ...
    <section class="relative min-h-[80vh] flex items-center bg-gradient-to-br from-slate-900 via-gray-900 to-slate-900">
      ...
      <div class="container mx-auto px-4 relative z-10" @fadeInUp>
  <div class="max-w-5xl mx-auto">
    <div class="text-center space-y-8">
      <div class="inline-flex items-center px-6 py-2 rounded-full bg-white/10 backdrop-blur-sm border border-white/20">
        <span class="text-gray-300 text-sm font-medium tracking-wider">WELCOME TO THE FUTURE OF LEARNING</span>
      </div>
      
      <h1 class="text-5xl md:text-6xl lg:text-7xl font-bold text-white leading-tight tracking-tight">
